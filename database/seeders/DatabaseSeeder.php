...
class DatabaseSeeder extends Seeder
{
    ...
    {
        // Run our specialized seeders in the correct order
        $this->call([
            SiteSeeder::class,       // Base site settings and configuration
            LayoutSeeder::class,     // Layout templates and components
            PageSeeder::class,       // Standard pages
            DesignSeeder::class,     // Page designs and content
        ]);}
    }
